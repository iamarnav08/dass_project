...
*Fig. 8.2:* (a) *A spring expands on application of force; (b) A spherical rubber ball becomes oblong as we apply force on it.*
...
We have been given that *u* = 3 m s–1 and *v* = 7 m s-1 , *t* = 2 s and *m* = 5 kg. From Eq. (8.5) we have,
